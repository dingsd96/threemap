...
import {getTifConvertImage, lonlatToMercator, lonlatToThree} from "@/utils/utils";
...
export default {
    ...
    setup() {
        ...
        // 创建光柱
        const initLightPoint = (properties, mapGroup, gauge) => {
                ...
                initModel() {
                    try {
                        ...
                        provinceData.features.forEach((elem, index) => {
                            ...
                            // 创建标点和标签
                            initLightPoint(properties, this.mapGroup, gauge);
